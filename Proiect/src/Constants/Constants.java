...
public class Constants {
    ...
    public static final int ROGUE_INIT_HP = 400;
    public static final int WIZARD_INIT_HP = 600;
    public static final int KNIGHT_LVL_HP = 80;
    public static final int PIROMANCER_LVL_HP = 50;
    public static final int ROGUE_LVL_HP = 30;
    public static final int WIZARD_LVL_HP = 40;
