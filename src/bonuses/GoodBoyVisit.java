...
public final class GoodBoyVisit implements AngelsVisitor {
    private static final int K_HP = 20;
    private static final int P_HP = 30;
    private static final int R_HP = 40;
    private static final int W_HP = 50;
    private static final float K_MOD = 4 / (10f);
    private static final float P_MOD = 5 / (10f);
    private static final float R_MOD = 4 / (10f);
    private static final float W_MOD = 3 / (10f);
