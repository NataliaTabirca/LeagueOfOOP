...
public final class DraculaVisit implements AngelsVisitor {
    private static final int K_HP = 60;
    private static final int P_HP = 40;
    private static final int R_HP = 35;
    private static final int W_HP = 20;
    private static final float K_MOD = 2 / 10f;
    private static final float P_MOD = 3 / 10f;
    private static final float R_MOD = 1 / 10f;
